            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto">
              {[
                ...
                },
                {
                  ...
                  features: ["1.200 créditos/mes", "200 productos por CSV", "Agente IA incluido", "Análisis competidor incluido", "Soporte prioritario"],
                  cta: "Empezar con Pro",
                  href: "/pricing",
                  highlight: true,
                },
                {
                  ...
                  features: ["5.000 créditos/mes", "Productos ilimitados", "API personalizada", "Account manager 24/7"],
                  cta: "Ver Enterprise",
                  href: "/pricing",
                  highlight: false,
                },
