  ...
  const SHARE_PLATFORMS = [
    {
      ...
      getHref: (text: string) => `https://wa.me/?text=${text}`,
    },
    {
      ...
      getHref: (text: string) => `https://twitter.com/intent/tweet?text=${text}`,
    },
    {
    ...
    },
    {
      ...
      getHref: (text: string) => `mailto:?subject=${encodeURIComponent("Te invito a ListWise")}&body=${text}`,
    },
  ];
