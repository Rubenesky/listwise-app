...
const REQUIRED_HOOK_TYPE: Record<string, { type: string; instruction: string }> = {
  "Ropa":            { type: "bold",     instruction: "Contraste con el cliché de prenda genérica de la categoría (sudadera/camiseta/pantalón básico), SIN usar la forma \"[algo] no es X; es Y\" en ningún fraseo. Ángulos: imperativo invitando a dejar atrás lo genérico (\"Deja atrás...\", \"Olvídate de...\"), afirmar directamente el carácter de quien la lleva, contraponer con una imagen concreta en vez de una negación." },
  "Moda":            { type: "bold",     instruction: "Contraste con el cliché de moda genérica, SIN usar la forma \"[algo] no es X; es Y\" en ningún fraseo. Ángulos: imperativo invitando a dejar atrás lo predecible, contraponer tendencia pasajera vs. pieza con carácter mediante una imagen concreta, afirmar identidad de estilo propio directamente." },
  ...
  "Accesorios":      { type: "bold",     instruction: "Contraste con el cliché de accesorio genérico, SIN usar la forma \"[algo] no es X; es Y\" en ningún fraseo. Ángulos: imperativo invitando a dejar atrás lo genérico, contraponer lo funcional-pero-anodino frente a esta pieza con una imagen concreta, afirmar directamente el detalle que marca la diferencia." },
  ...
  "POD":             { type: "bold",     instruction: "Singularidad del producto personalizado, SIN usar la forma \"[algo] no es X; es Y\" en ningún fraseo. Ángulos: contraste entre producción en masa y pieza única mediante una imagen concreta, afirmar directamente que existe solo porque el comprador lo creó, subrayar que no hay otro igual en el mundo." },
...
TÉCNICAS DE ALTO IMPACTO (úsalas cuando el producto las justifica):
  ...
  CONTRAST FRAME: contrasta el producto con el cliché de su categoría para remarcar su diferencial. PROHIBIDO usar la forma "[algo] no es X; es Y" en cualquier fraseo (esto incluye variantes como "Un bolso no es solo...", "No es solo una mochila..." — no solo "Esto no es..."). Formula el contraste con un imperativo o una afirmación directa sin negación previa.
...
13. ¿Alguna frase de la descripción tiene la forma "[algo] no es X; es Y" — con CUALQUIER fraseo o sujeto, no solo "Esto no es" (ej: "Un bolso no es solo...", "No es solo una mochila...", "Esta prenda no es otra..."), o contiene la palabra "declaración"? → REESCRIBE completamente esa frase con otra estructura gramatical (imperativo, afirmación directa sin negación, o pregunta) — cambiar solo las palabras sin cambiar la estructura de negación+afirmación no cuenta como corregido.
</AUTOVERIFICACION>
