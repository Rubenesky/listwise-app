...
const REQUIRED_HOOK_TYPE: Record<string, { type: string; instruction: string }> = {
  "Ropa":            { type: "bold",     instruction: "Contraste con el cliché de prenda genérica de la categoría (sudadera/camiseta/pantalón básico), SIN usar la forma \"[algo] no es X; es Y\" en ningún fraseo, y SIN usar las palabras \"declaración\" o \"redefine\". Ángulos: invitar a superar lo genérico con tono imperativo (el verbo es tuyo, no hay uno correcto — evita repetirlo entre productos), afirmar directamente el carácter de quien la lleva, contraponer con una imagen concreta en vez de una negación." },
  "Moda":            { type: "bold",     instruction: "Contraste con el cliché de moda genérica, SIN usar la forma \"[algo] no es X; es Y\" en ningún fraseo, y SIN usar las palabras \"declaración\" o \"redefine\". Ángulos: invitar a superar lo predecible con tono imperativo (el verbo es tuyo, no hay uno correcto — evita repetirlo entre productos), contraponer tendencia pasajera vs. pieza con carácter mediante una imagen concreta, afirmar identidad de estilo propio directamente." },
  ...
  "Accesorios":      { type: "bold",     instruction: "Contraste con el cliché de accesorio genérico, SIN usar la forma \"[algo] no es X; es Y\" en ningún fraseo, y SIN usar las palabras \"declaración\" o \"redefine\". Ángulos: invitar a superar lo genérico con tono imperativo (el verbo es tuyo, no hay uno correcto — evita repetirlo entre productos), contraponer lo funcional-pero-anodino frente a esta pieza con una imagen concreta, afirmar directamente el detalle que marca la diferencia." },
  ...
  "POD":             { type: "bold",     instruction: "Singularidad del producto personalizado, SIN usar la forma \"[algo] no es X; es Y\" en ningún fraseo, y SIN usar las palabras \"declaración\" o \"redefine\". Ángulos: contraste entre producción en masa y pieza única mediante una imagen concreta, afirmar directamente que existe solo porque el comprador lo creó, subrayar que no hay otro igual en el mundo." },
...
El primer párrafo es el gancho:
  ...
  PROHIBIDO en cualquier parte de la descripción: la palabra "declaración" (ej: "es una declaración de estilo/funcionalidad") y la palabra "redefine" (ej: "esta chaqueta redefine la utilidad") — son muletillas vacías que no dicen nada del producto concreto.
  ...
  - Declaración audaz: contrasta el producto con el cliché genérico de su categoría, pero NUNCA con la forma "[algo] no es X; es Y" (en NINGÚN fraseo — ni "Esto no es...", ni "Un/una [producto] no es...", ni "No es solo..."). Puedes usar un tono imperativo o una afirmación directa sin negación previa — pero el verbo y la construcción exactos son tuyos: no hay un verbo "correcto" para esto, invéntalo tú cada vez y evita repetir el mismo verbo o giro entre productos distintos.
...
TÉCNICAS DE ALTO IMPACTO (úsalas cuando el producto las justifica):
  ...
  CONTRAST FRAME: contrasta el producto con el cliché de su categoría para remarcar su diferencial. PROHIBIDO usar la forma "[algo] no es X; es Y" en cualquier fraseo (esto incluye variantes como "Un bolso no es solo...", "No es solo una mochila..." — no solo "Esto no es..."), y PROHIBIDO usar las palabras "declaración" o "redefine". Formula el contraste con un imperativo o una afirmación directa sin negación previa — el verbo y la construcción son tuyos, no repitas el mismo giro entre productos.
...
13. ¿Alguna frase de la descripción tiene la forma "[algo] no es X; es Y" — con CUALQUIER fraseo o sujeto, no solo "Esto no es" (ej: "Un bolso no es solo...", "No es solo una mochila...", "Esta prenda no es otra..."), o contiene la palabra "declaración" o "redefine"? → REESCRIBE completamente esa frase con otra estructura gramatical (imperativo, afirmación directa sin negación, o pregunta) — cambiar solo las palabras sin cambiar la estructura de negación+afirmación no cuenta como corregido.
14. ¿El gancho tiene la forma "[imperativo de dejar atrás/olvidar lo genérico]. [Producto] + verbo que anuncia su diferencial (redefine, transforma, eleva...)."? → Aunque no repitas "declaración" ni "redefine" literalmente, esa ES la misma plantilla con otras palabras. REESCRIBE con una estructura genuinamente distinta a la de otros productos ya generados en esta sesión.
</AUTOVERIFICACION>

Responde SIEMPRE con JSON válido exactamente con estos campos. Nada de texto fuera del JSON:
{"title":"...","title_b":"Estrategia OPUESTA a title: si title es benefit-lead entonces title_b es keyword-lead; si title es emocional entonces title_b es técnico y específico","bullets":["..."],"description":"string con la descripción completa siguiendo las reglas de la sección DESCRIPCIÓN de arriba (2 a 3 párrafos de prosa real sobre el producto, separados por \\n\\n — sin encabezados, sin numerar los párrafos, sin ninguna etiqueta antes de cada párrafo)","primary_keyword":"2-4 palabras como las escribiría el comprador en el buscador","target_audience":"2-3 palabras describiendo el comprador ideal","hook_type":"scene|question|bold|benefit","quality_flags":{"no_trademarks":true,"title_in_range":true,"bullets_concise":true,"attrs_real":true,"hook_differentiated":true}}
`;
